...
This document provides methods and best practices for updating the Spark Router system to ensure a smooth upgrade to the latest version.
...
If you have deployed Spark Router using a single Docker container, you can update by following these steps:
...
2.  Find the Spark Router application and click the **Upgrade** button
...
2.  Find the Spark Router container, click **More** -> **Recreate**
...
If you have deployed Spark Router by compiling from source code, the update steps are as follows:
