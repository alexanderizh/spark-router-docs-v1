...
This document provides a graphical tutorial for deploying Spark Router using the Baota Panel Docker feature.
...
After installation, you can access Spark Router at the following address:
...
### 1. Unable to access Spark Router interface
