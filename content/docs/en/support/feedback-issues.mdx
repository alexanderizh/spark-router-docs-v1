...
<Callout type="warn" title="Notice">
  - Please strictly follow the template format when submitting issues - Use
  clear titles to help other users search - Please pay attention to and reply to
  your submitted issues in a timely manner - Issues that do not meet the
  requirements may be closed directly - If your issue is resolved, please close
  it promptly
</Callout>
