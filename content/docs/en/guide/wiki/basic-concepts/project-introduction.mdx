...
description: Learn about Spark Router, the next-generation AI Gateway and Asset Management System
---
...
<div className="my-8 text-center">
  <img
    ...
    height="120"
  />
  <h1 className="mt-4 mb-2 text-4xl font-bold">Spark Router</h1>
  <img
    src="/assets/trendshift.svg"
    alt="Spark Router Trendshift Badge"
...
Spark Router is a next-generation AI foundation platform, providing unified infrastructure for your AI applications. It hosts all AI applications, manages your digital assets, and connects to a future unified interface platform.

<Callout type="info">
  Spark Router seamlessly integrates with mainstream global AI service providers, including OpenAI, Anthropic, Google
...
Spark Router adopts the **GNU AGPLv3** open-source license, which can be used for free as long as the terms of the open-source license are followed.

<Callout type="warn">
  Before using Spark Router, please read the complete license terms in the [Project
  LICENSE](https://github.com/QuantumNous/new-api/blob/main/LICENSE).
</Callout>

### Open Source License (AGPLv3)

Under AGPLv3, you are free to use, modify, and distribute Spark Router.
...
All contributions to Spark Router are licensed under AGPLv3.
...
<Callout type="error">Before using Spark Router, please read and understand these important statements.</Callout>
...
<Callout type="warn">
  Spark Router is provided "as is" without any warranties of any kind. Developers and maintainers are not liable for any damages or legal issues arising from the use of this software.
</Callout>