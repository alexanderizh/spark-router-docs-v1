...
Spark Router provides quick access to several AI chat applications, making them convenient for testing or use.
...
<Callout type="warn">
  ...
  Spark Router; manual entry is required.
</Callout>
...
<Callout type="info">
  Supports one-click configuration import from Spark Router
</Callout>

## AMA 问天

<Callout type="info">
  AMA 问天 is an intelligent Q&A assistant provided by Spark Router, supporting
