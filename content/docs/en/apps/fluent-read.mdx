...
<Callout type="info" title="Chat Settings Options">
  In the System Settings -> Chat Settings of the Spark Router console, you can add
...
### Import Configuration from Spark Router Console (Recommended)

After the FluentRead plugin is installed in your browser, opening the Spark Router console -> Token Management page will display a prompt to add FluentRead.
...
After confirming the import, the Spark Router configuration in FluentRead will be enabled.
...
| ------------------- | --------------------------------------- |
| Translation Service | Spark Router                                  |
| Access Token        | Spark Router Key                              |
| Spark Router Endpoint     | Spark Router Deployment Address (without /v1) |
