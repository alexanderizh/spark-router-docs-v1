...
<Callout type="info" title="Chat settings option">
  ...
  following quick option to enable one-click fill to FluentRead from the API
  Keys page:
</Callout>
...
<Callout type="info">
  🌊 FluentRead is a revolutionary open-source browser translation plugin,
  enabling everyone to have a native-like reading experience.
</Callout>
