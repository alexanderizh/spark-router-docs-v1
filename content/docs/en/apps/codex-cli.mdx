...
<Callout type="info" title="Install WSL2, Restart Windows Computer">
  ` wsl --install ` Restart the Windows computer after installation
</Callout>
...
<Callout type="info" title="NVM Install Node.js 22">
  Open a new PowerShell window in the tab bar and start WSL ` wsl `
</Callout>
...
<Callout type="info" title="Launch Codex CLI">
  Start WSL2 ` wsl ` Launch Codex CLI directly: ` codex ` Use in a specific
...
<Callout type="info">
  rmation "Verify Successful Installation" After installation, open the terminal
  and enter the following commands: ` node --version npm --version ` If the
  version number is displayed, the installation was successful
</Callout>

#### 3. Install Codex CLI

<Callout type="info" title="Install Codex CLI">
  Open the terminal and run the following command: ` # Install Codex CLI
...
<Callout type="info" title="Verify Codex CLI Installation">
  ...
  was successful: ` codex --version ` If the version number is displayed,
