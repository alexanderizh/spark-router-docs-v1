...
<Callout type="info" title="Chat settings option">
  In the New API Console under System Settings -> Chat settings, you can add the
  following quick option to enable one-click fill to Cherry Studio from the API
  Keys page:
</Callout>
...
<Callout type="info">
  ...
  users, integrating 30+ industry-specific AI assistants to meet various work
  scenario requirements and significantly improve work efficiency.
</Callout>
