...
<Callout type="info" title="Droid CLIの起動">
  Droid CLI を直接起動: ` # 起動 Droid CLI droid `
  特定のプロジェクトで使用する場合: ` # プロジェクトディレクトリに移動 cd
  C:\path\to\your\project ` ` # 起動 Droid CLI droid ` Enter で Droid CLI を起動
</Callout>
...
<Callout
  type="info"
  title="インストール時に「permission denied」エラーが表示される場合"
  collapsible
>
...
<Callout type="info" title="PowerShell 実行ポリシーエラー" collapsible>
...
<Callout type="info" title="Droid CLIの起動">
  Droid CLI を直接起動: ` # 起動 Droid CLI droid `
  特定のプロジェクトで使用する場合: ` # プロジェクトディレクトリに移動 cd
  /path/to/your/project ` ` # 起動 Droid CLI droid ` Enter で Droid CLI を起動
</Callout>
